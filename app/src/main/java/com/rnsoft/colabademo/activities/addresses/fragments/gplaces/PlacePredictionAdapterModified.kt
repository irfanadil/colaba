 ...
 */
class PlacePredictionAdapterModified : RecyclerView.Adapter<PlacePredictionAdapterModified.PlacePredictionViewHolder>() {
    private val predictions: MutableList<String> = ArrayList()
    ...
    fun setPredictions(predictions: ArrayList<String>) {
