...
class DeleteMailingAddressDailog : BottomSheetDialogFragment() {

    companion object {
        lateinit var deleteText:String
        fun newInstance(text:String): DeleteMailingAddressDailog {
            deleteText = text
            return DeleteMailingAddressDailog()
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        binding.yesBtn.setOnClickListener {
            dismiss()
            EventBus.getDefault().post(MailingAddressDeleteEVent(true))
        }
